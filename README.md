# Отчет по Лабораторной работе №1. Unit tests
...
В рамках работы тестируется учебный проект на Python. Была реализована программа для учёта товаров без графического интерфейса. Проект представляет собой небольшую систему учёта с базовыми возможностями (добавление/удаление товаров, просмотр разного вида, сортировки). Хранение данных производится в файле products.json.
...
- добавление/удаление товаров (так как происходит изменение списка товаров в файле)
...
7. Тест для проверки удаления товара
